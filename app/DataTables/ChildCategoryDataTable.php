    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                return '<a href="' . route('admin.childcategory.edit', $query->id) . '" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>Edit</a>
        <a href="' . route('admin.childcategory.destroy', $query->id) . '"  class="btn btn-sm btn-danger delete-item"><i class="fa fa-trash"></i>Delete</a>';
            })
            ...
            ->addColumn('Change Status', function ($query) {
            ...
            ->rawColumns(['action', 'status', 'category', 'subcategory', 'Change Status'])
            ->setRowId('id');
    }
