    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                return '<a href="' . route('admin.subcategory.edit', $query->id) . '" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>Edit</a>
            <a href="' . route('admin.subcategory.destroy', $query->id) . '"  class="btn btn-sm btn-danger delete-item"><i class="fa fa-trash"></i>Delete</a>';
            })
            ...
            ->rawColumns(['action', 'status', 'category', 'Change Status'])
            ->setRowId('id');
    }
