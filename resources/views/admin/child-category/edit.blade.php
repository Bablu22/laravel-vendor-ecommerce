                        ...
                        <form action="{{ route('admin.childcategory.update',$childCategory->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single form-control" name="category_id">
                                    ...
                                    <option {{$childCategory->category_id == $category->id ? 'selected':''}} value="{{
                                        $category->id
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single form-control" name="subcategory_id">
                                    @foreach($subCategories as $category)

                                    <option {{$childCategory->subcategory_id == $category->id ? 'selected':''}}
                                        value="{{
                                        $category->id
                                        }}">{{ $category->name }}</option>
                                    @endforeach
